...
$prep="INSERT INTO professeur(nom_prof, prenom_prof, profession_prof, description_prof, email_prof, tarif_prof) VALUES (:nom, :prenom, :profession, :description, :email, :tarif)";
